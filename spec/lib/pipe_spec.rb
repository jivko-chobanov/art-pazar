describe "Pipe" do
  ...
  context "when undefined command" do
    it "raises exceptions" do
      expect { pipe.get :runtime_table_obj_content, 1 }.to raise_error RuntimeError
      expect { pipe.get :runtime_table_obj_content, qqqq: 4 }.to raise_error RuntimeError
      expect { pipe.get :runtime_table_obj_content, data_obj_name: "Products" }
        .to raise_error Pipe::MissingNeedOrInputError
      expect { pipe.get :runtime_table_obj_content, data_obj_name: "Qqq" }
  ...
  it "gets the data for data object" do
    three_products_for_listing = pipe.get(:runtime_table_obj_content, {
